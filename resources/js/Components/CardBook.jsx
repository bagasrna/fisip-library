    ...
    return (
        <div className="card p-5 max-w-xs rounded-3xl m-5" style={{ boxShadow: "0px 0px 10px rgba(0, 0, 0, 0.25)" }}>
            <div className="card-image">
                <img src="/images/book-cover.svg" width="100%" />
            </div>
            <div>
                <h3 className="text-3xl my-2 font-bold">Kitab Kawin</h3>
                <p className="my-1">Laksmi Pamuntjak</p>
            </div>
            ...
            <div>
                <p>Perpustakaan Kota Malang, 2+</p>
            </div>
        </div>
    );
}