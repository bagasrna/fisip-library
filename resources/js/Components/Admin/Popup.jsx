        ...
        <AnimatePresence>
            {open && (
                <motion.div
                    ...
                    className={`rounded-lg fixed top-10 left-10 flex flex-col z-40 bg-white`}
                ...
                >
                    <div className="flex items-center p-10">
...

                        {
                            status ?
                                <div>
                                    <motion.svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 ml-2 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    ...
                    <motion.div
                        ...
                        className={`${status ? "bg-green-500" : status === false ? "bg-red-500" : status === undefined ? "bg-slate-400" : ""} opacity-50  h-2`}
                    />
                </motion.div>)
            }
        </AnimatePresence>
